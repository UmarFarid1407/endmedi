...
export const addUserDetails = async (userDetails: any, userID: number) => {
  try {
    ...
    const response = await axios.put(
      `${API_URL_USER}/userdetail/${userID}`,
      userDetails,
      {
        headers: {
...
export const getCheckoutSession = async (sessionId: string) => {
  try {
    const response = await axios.get(
      `/api/order/checkout-session/${sessionId}`
    );
    return response.data;
  } catch (error: any) {
    console.error("Error fetching session data:", error);
    throw new Error(
      error.response?.data?.message || "Error while fetching session data"
    );
  }
};
...
export const getAllPharmacyCartsWithCategory = async (category: string) => {
  try {
    ...
    const response = await axios.get(
      `${API_URL_ORDER}/cartcategory/${category}`,
      {
        headers: {
          Authorization: `Bearer ${getdecodedToken}`,
        },
...
export const createMedicine = async (data: MedicineData) => {
  try {
    ...
    const response = await axios.post(
      `${API_URL_MEDICINES}/createmedicine`,
      data,
      {
        headers: {
          Authorization: `Bearer ${getdecodedToken}`,
...
export const getMedicineById = async (medid: number) => {
  try {
    ...
    const getdecodedToken = decodeToken(shouldDecode);
    const response = await axios.get(
      `${API_URL_MEDICINES}/getmedbyid/${medid}`,
      {
        headers: {
          Authorization: `Bearer ${getdecodedToken}`,
        },
...
export const updateMedicine = async (id: number, data: Partial<Medicine>) => {
  try {
    ...
    const getdecodedToken = decodeToken(shouldDecode);
    const response = await axios.put(
      `${API_URL_MEDICINES}/medicineupdate/${id}`,
      data,
      {
        headers: {
          Authorization: `Bearer ${getdecodedToken}`,
...
export const getMedicinesBySellerID = async (sellerID: number) => {
  try {
    ...
    const response = await axios.get(
      `${API_URL_MEDICINES}/seller/${sellerID}`,
      {
        headers: {
          Authorization: `Bearer ${getdecodedToken}`,
        },
...
export const deleteMedicine = async (id: number) => {
  try {
    ...
    const response = await axios.delete(
      `${API_URL_MEDICINES}/deletemedicine/${id}`,
      {
        headers: {
          Authorization: `Bearer ${getdecodedToken}`,
        },
...
export const getCartBySellerID = async (userId: number) => {
  try {
    ...
    const getdecodedToken = decodeToken(shouldDecode);
    const response = await axios.get(
      `${API_URL_ORDER}/cartwithsellerid/${userId}`,
      {
        headers: {
          Authorization: `Bearer ${getdecodedToken}`,
        },
...
export const getCartByPharmacistID = async (userId: number) => {
  try {
    ...
    const getdecodedToken = decodeToken(shouldDecode);
    const response = await axios.get(
      `${API_URL_ORDER}/cartwithpharmacistid/${userId}`,
      {
        headers: {
          Authorization: `Bearer ${getdecodedToken}`,
        },
...
export const getCartByPharmacistIDPagination = async (
  userId: number,
  page: number,
  limit: number
) => {
  try {
    ...
    const getdecodedToken = decodeToken(shouldDecode);
    const response = await axios.get(
      `${API_URL_ORDER}/cartwithpharmacistidpagination/${userId}?page=${page}&limit=${limit}`,
      {
        headers: {
          Authorization: `Bearer ${getdecodedToken}`,
        },
...
export const removeCartByPharmacistCartID = async (cartItemId: number) => {
  try {
    ...
    const getdecodedToken = decodeToken(shouldDecode);
    const response = await axios.delete(
      `${API_URL_ORDER}/remove/${cartItemId}`,
      {
        headers: {
          Authorization: `Bearer ${getdecodedToken}`,
        },
    ...
    throw new Error(
      error.response?.data?.message || "Failed to delete cart of pharmacy ."
    );
  }
};
...
export const getCartByPharmacistIDForUserCart = async (userId: number) => {
  try {
    ...
    const getdecodedToken = decodeToken(shouldDecode);
    const response = await axios.get(
      `${API_URL_ORDER}/cartwithuseridforpharmacist/${userId}`,
      {
        headers: {
          Authorization: `Bearer ${getdecodedToken}`,
        },
...
export const getCartByUserIDForUserCart = async (userId: number) => {
  try {
    ...
    const getdecodedToken = decodeToken(shouldDecode);
    const response = await axios.get(
      `${API_URL_ORDER}/cartwithuseridforuser/${userId}`,
      {
        headers: {
          Authorization: `Bearer ${getdecodedToken}`,
        },
